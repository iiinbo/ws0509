        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- if : 로그인 안한 고객은 login , register / 로그인 고객은 logout -->
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="/logoutimpl" data-toggle="modal" data-target="#logoutModal">
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">정말 로그아웃을 진행하시겠습니까?</div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">돌아가기</button>
                <a class="btn btn-primary" href="/logoutimpl">확인</a>
            </div>
        </div>
    </div>
</div>
